---
layout: post
title: Vietnamese Word2Vec
published: true
---
## Word2Vec model trained from news data

Model train with raw Vietnamese text extract from over 2 million news from various news source of Vietnam like Dantri, Tuoitre, Thanhnien, ...

Using only title, description and news content for word2vec training

[Model with .bin and .vec file](https://drive.google.com/drive/folders/16EVc2lYJRbewHEfW8f9mYz_G6sI0pF00?usp=sharing)
